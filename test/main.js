...
sts.assumeRole({
    ...
    if (err) { // an error occurred
        ...
        // var event = require('./requests/SessionEndedRequest.json');
        // var event = require('./requests/Unhandled.json');

        // var event = require('./requests/AMAZON.CancelIntent.json');
        // var event = require('./requests/AMAZON.HelpIntent.json');
        // var event = require('./requests/AMAZON.RepeatIntent.json');
        // var event = require('./requests/AMAZON.StopIntent.json');

        // var event = require('./requests/GetNewFactIntent.json');
        // var event = require('./requests/GetFactByNumberIntent.Invalid.json');
        // var event = require('./requests/GetFactByNumberIntent.json');

        //fix up applicationId before passing to handler
        event.session.application.applicationId = constants.skillAppID;
